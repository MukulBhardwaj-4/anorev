...
export function RoomCard({
  ...
  return (
    <Card className="group h-full w-full min-h-50 flex flex-col overflow-hidden border-border transition-all hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-md">
      ...
      <CardFooter>
        <Button onClick={handleCheck} variant="outline" className="w-full group-hover:border-primary/50 group-hover:bg-primary group-hover:text-primary-foreground">Check</Button>      </CardFooter>
    </Card>
  )
}
